...
export const projects: Project[] = [
  ...
  {
    id: "psychcoherence",
    title: "Psychological Coherence",
    description: "A Model Context Protocol (MCP) server implementing psychologically-informed, rule-based text generation.",
    tech: ["Python", "MCP", "Psychology"],
    category: "ai",
    type: "ai",
    path: "projects/mcp/psychcoherence.py",
    details: "Implements functional, stateful tools for persona-driven dialogue with memory, contradiction detection, and mood-adaptive generation. Based on the Psychological Coherence Framework.",
  },
];
